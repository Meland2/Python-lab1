...
if __name__ == "__main__":
    book1 = Book(name="Pool", author="R.K.Grout")
    print(book1)

    paper_book1 = PaperBook(name="House", author="S.S Faush", pages=220)
    print(paper_book1)
    ...
    audio_book1 = AudioBook(name="War and Peace", author="L.N. Tolstoy", duration=6)
    print(audio_book1)
